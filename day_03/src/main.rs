// Puzzle from: https://adventofcode.com/2022/day/3
...
fn generate_rucksacks() -> Vec<Rucksack> {
    ...
    for line in INPUT.lines() {
        let rucksack = Rucksack::get_rucksack_from_input(line);
...
impl Rucksack {
    fn get_rucksack_from_input(string: &str) -> Self {
        let mut first_compartment = Vec::new();
        let mut second_compartment = Vec::new();

        // enumerate() gives the iteration count
